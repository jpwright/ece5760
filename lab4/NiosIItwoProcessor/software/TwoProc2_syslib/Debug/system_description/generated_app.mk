...
#
# Generated: 2006-10-10 15:43:50.671
...
hex: $(QUARTUS_PROJECT_DIR)/onchip_memory_1.hex
.PHONY: hex
...
$(QUARTUS_PROJECT_DIR)/onchip_memory_1.hex: $(ELF)
	@echo Post-processing to create $(notdir $@)
	elf2hex $(ELF) 0x00020000 0x23FFF --width=32 $(QUARTUS_PROJECT_DIR)/onchip_memory_1.hex --create-lanes=0
...
generated_app_clean:
	$(RM) $(QUARTUS_PROJECT_DIR)/onchip_memory_1.hex
