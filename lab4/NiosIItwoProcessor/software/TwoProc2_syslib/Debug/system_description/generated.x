 ...
 *
 * Generated: 2006-10-10 15:43:55.609
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x00020000, LENGTH = 32
    onchip_memory_1 : ORIGIN = 0x00020020, LENGTH = 16352
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_memory_1 = 0x00020000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  onchip_memory_1 =0x3a880100 /* NOP on Nios2 (big endian) */
    ...
    .onchip_memory_1 LOADADDR (.bss) + SIZEOF (.bss): AT (LOADADDR (.bss) + SIZEOF (.bss))
    {
        PROVIDE (_alt_partition_onchip_memory_1_start = ABSOLUTE(.));
        *(.onchip_memory_1 .onchip_memory_1.*)
        . = ALIGN(32 / 8);
