 ...
 *
 * Generated: 2006-10-10 15:46:35.468
 *
 */
...
MEMORY
{
    ...
    onchip_memory_0 : ORIGIN = 0x00010020, LENGTH = 16352
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_memory_0 = 0x00010000 ;
...
SECTIONS
{
    ...
    .onchip_memory_0 LOADADDR (.bss) + SIZEOF (.bss): AT (LOADADDR (.bss) + SIZEOF (.bss))
    {
